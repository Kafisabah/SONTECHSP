...
class TestKurulumModulBagimliliklari:
    ...
    def test_kurulum_modulu_import(self):
        ...
        try:
            from uygulama.kurulum import sabitler
            from uygulama.kurulum import klasorler
            from uygulama.kurulum import ayar_olusturucu
            from uygulama.kurulum import veritabani_kontrol
            from uygulama.kurulum import admin_olusturucu
            from uygulama.kurulum import baslat
            assert True
        except ImportError as e:
