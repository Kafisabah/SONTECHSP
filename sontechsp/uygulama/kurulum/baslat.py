...
from sontechsp.uygulama.cekirdek.kayit import kayit_al, kayit_sistemi_al
from sontechsp.uygulama.cekirdek.hatalar import SontechHatasi, EntegrasyonHatasi, DogrulamaHatasi
...
class KurulumYoneticisi:
    ...
    def _klasorleri_olustur(self) -> None:
        ...
        ozel_klasorler = {"logs": 0o755, "data": 0o750, "config": 0o750, "backup": 0o750}
    ...
    def _yapilandirma_dosyasi_olustur(self) -> None:
        ...
        varsayilan_config = {
            ...
            "sqlite": {"path": "data/sontechsp_cache.db", "echo": False},
            "logging": {
                "level": "INFO",
            ...
            "security": {"secret_key": "CHANGE_ME_TO_RANDOM_STRING", "session_timeout": 3600, "password_min_length": 8},
            "ui": {"theme": "default", "language": "tr", "window_size": [1400, 900], "auto_save": True},
            "business": {"company_name": "Şirket Adı", "tax_number": "", "address": "", "phone": "", "email": ""},
        }
...
"""
    ...
    def _kurulum_tamamlandi_isaretle(self) -> None:
        ...
        kurulum_bilgileri = {"kurulum_tarihi": "2024-12-15", "versiyon": "0.1.0", "kurulum_turu": "tam_kurulum"}
    ...
    def kurulum_durumu_kontrol_et(self) -> Dict[str, Any]:
        ...
        if kurulum_dosyasi.exists():
            try:
                ...
                return {"kurulum_tamamlandi": True, "kurulum_bilgileri": kurulum_bilgileri}

            except Exception as e:
                self.logger.warning(f"Kurulum dosyası okuma hatası: {e}")

        return {"kurulum_tamamlandi": False, "kurulum_bilgileri": None}
