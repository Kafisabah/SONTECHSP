...
class GostergePaneli(TemelEkran):
    ...
    def kartlar_olustur(self):
        ...
        # Kritik stok kartı
        kritik_stok_kart = self.kart_olustur(
            "Kritik Stok", 
            "0 Ürün", 
            "#e74c3c"
        )
        ...
        bekleyen_siparis_kart = self.kart_olustur(
            "Bekleyen Sipariş", 
            "0 Sipariş", 
            "#f39c12"
        )
    ...
    def hizli_erisim_butonlari_olustur(self):
        ...
        """)
        pos_buton.clicked.connect(lambda: self.hizli_erisim_tiklandi("pos_satis"))
        ...
        """)
        stok_buton.clicked.connect(lambda: self.hizli_erisim_tiklandi("urunler_stok"))
