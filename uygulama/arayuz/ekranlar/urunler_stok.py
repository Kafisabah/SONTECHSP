...
from PyQt6.QtWidgets import (QHBoxLayout, QVBoxLayout, QLabel, QPushButton, 
                             ...
                             QGridLayout, QHeaderView, QComboBox, QSpinBox,
                             QGroupBox, QSplitter)
...
class UrunlerStok(TemelEkran):
    ...
    def filtre_grubu_olustur(self):
        ...
        self.kategori_combo.addItems([
            "Tümü", "Elektronik", "Giyim", "Gıda", "Ev & Yaşam", "Spor", "Diğer"
        ])
        ...
        self.stok_combo.addItems([
            "Tümü", "Stokta Var", "Kritik Seviye", "Stokta Yok"
        ])
    ...
    def hizli_islemler_grubu_olustur(self):
        ...
        """)
        kritik_stok_buton.clicked.connect(self.kritik_stok_raporu)
        ...
        """)
        deger_raporu_buton.clicked.connect(self.stok_deger_raporu)
    ...
    def ust_butonlar_olustur(self):
        ...
        """)
        self.yeni_urun_buton.clicked.connect(self.yeni_urun_ekle)
        ...
        """)
        self.duzenle_buton.clicked.connect(self.urun_duzenle)
        ...
        """)
        self.sayim_buton.clicked.connect(self.stok_sayim)
        ...
        """)
        self.transfer_buton.clicked.connect(self.stok_transfer)
    ...
    def urun_tablosunu_guncelle(self):
        ...
        try:
            ...
            for row, urun in enumerate(self.urun_verileri):
                ...
                self.urun_tablo.setItem(row, 5, QTableWidgetItem(
                    UIYardimcilari.para_formatla(urun["birim_fiyat"])
                ))
                self.urun_tablo.setItem(row, 6, QTableWidgetItem(
                    UIYardimcilari.para_formatla(urun["toplam_deger"])
                ))
    ...
    def durum_cubugunu_guncelle(self):
        ...
        try:
            ...
            self.toplam_deger_label.setText(
                f"Toplam Stok Değeri: {UIYardimcilari.para_formatla(toplam_deger)}"
            )
