...
class Musteriler(TemelEkran):
    ...
    def filtre_grubu_olustur(self):
        ...
        self.musteri_tipi_combo.addItems([
            "Tümü", "Bireysel", "Kurumsal", "VIP", "Pasif"
        ])
        ...
        self.sadakat_combo.addItems([
            "Tümü", "Bronz", "Gümüş", "Altın", "Platin"
        ])
        ...
        self.tarih_combo.addItems([
            "Tümü", "Son 30 Gün", "Son 3 Ay", "Son 6 Ay", "Son 1 Yıl"
        ])
    ...
    def musteri_tablosunu_guncelle(self):
        ...
        try:
            ...
            for row, musteri in enumerate(self.musteri_verileri):
                ...
                self.musteri_tablo.setItem(row, 7, QTableWidgetItem(
                    UIYardimcilari.tarih_formatla(musteri["son_alisveris"])
                ))
