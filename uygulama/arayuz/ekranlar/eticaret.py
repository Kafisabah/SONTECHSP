    ...
    def siparis_cek(self):
        ...
        try:
            ...
            sonuc = self.servis_cagir_guvenli(
                eticaret_servisi.siparis_cek, 
                self.aktif_magaza_id
            )
    ...
    def siparis_tablosunu_guncelle(self):
        ...
        try:
            ...
            for row, siparis in enumerate(self.siparis_verileri):
                ...
                self.siparis_tablo.setItem(row, 4, QTableWidgetItem(
                    UIYardimcilari.para_formatla(siparis["tutar"])
                ))
                ...
                self.siparis_tablo.setItem(row, 6, QTableWidgetItem(
                    UIYardimcilari.tarih_formatla(siparis["tarih"])
                ))
